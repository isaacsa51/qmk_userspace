...
![Kyria Colemak-DH base layer — green keys are home-row mods, blue are layer keys, purple are custom/tap-dance keys](keyboards/splitkb/halcyon/kyria/keymaps/isaacsa51/res/alpha-layer.svg)
